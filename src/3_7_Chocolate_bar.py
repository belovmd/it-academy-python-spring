...
print('\nВторая задача:')
# сразу отламываем от одной стороны:
second(3, 5, 6)
# сразу отламываем от другой стороны:
second(3, 5, 10)
"""сначала отламываем от большей стороны,
остаток отламываем от меньшей за 1 раз:"""
second(3, 5, 7)
"""сначала отламываем от меньшей стороны,
остаток отламываем от "большей" за 1 раз:"""
second(4, 5, 11)
"""все прочие случаи: максимально возможное
число разломов:"""
second(3, 5, 8)
# неверно указан размер k:
second(3, 5, 16)
